...
export const fleetSafetySeedData: SeedCaseData = {
  ...
  caseMeta: {
    ...
    priority: "high",
    severity: "moderate",
    createdAt: "2025-10-28T07:42:00Z",
  ...
  evidence: [
    {
      ...
      uploadedAt: "2025-10-28T08:10:00Z",
      description:
    ...
    },
    {
      ...
      uploadedAt: "2025-10-28T09:05:00Z",
      description:
    ...
    },
    {
      ...
      uploadedBy: "Supervisor M. Okafor (ops portal)",
      uploadedAt: "2025-10-28T09:08:00Z",
      description:
    ...
    },
    {
      ...
      uploadedAt: "2025-10-28T11:30:00Z",
      description:
    ...
    },
    {
      ...
      uploadedAt: "2025-10-29T09:45:00Z",
      description:
    ...
    },
    {
      ...
      uploadedAt: "2025-10-29T15:20:00Z",
      description:
  ...
  extraction: {
    ...
    sections: {
      incidentSummary: {
        type: "text",
        content:
          "On October 28, 2025 at approximately 07:35 AM, Unit V-183 (2023 Ford Transit 350, driven by Darnell Hughes) made low-speed contact with a stationary forklift at Bay 4 of the Eastport Distribution Center. The driver was momentarily distracted by an incoming dispatch notification on the in-cab tablet during a reversing maneuver. Speed at impact was 4.2 mph per dashcam data. No injuries were sustained. Damage is limited to the rear bumper assembly and trailer hitch receiver on V-183, with minor cosmetic impact on the forklift counterweight housing. The vehicle has been inspected and cleared for operations pending cosmetic repair ($380 estimated). Contributing factors include tablet distraction and a zone compliance failure by warehouse staff.",
      },
      timeline: {
        type: "timeline",
        entries: [
          { time: "2025-10-28 07:35", event: "Unit V-183 begins reversing maneuver into Bay 4" },
          { time: "2025-10-28 07:35", event: "Driver interacts with in-cab dispatch tablet (~8s before impact)" },
          { time: "2025-10-28 07:36", event: "Low-speed contact with stationary forklift at 4.2 mph" },
          { time: "2025-10-28 07:40", event: "Driver reports incident to dispatch and calls supervisor" },
          { time: "2025-10-28 08:10", event: "Supervisor M. Okafor arrives at Bay 4, scene secured" },
          { time: "2025-10-28 08:10", event: "Driver statement collected via driver portal" },
          { time: "2025-10-28 09:08", event: "Scene and damage photos uploaded by supervisor" },
          { time: "2025-10-28 11:30", event: "Supervisor note submitted; in-cab tablet policy reviewed with driver" },
          { time: "2025-10-29 09:45", event: "Fleet maintenance inspection completed; vehicle cleared" },
          { time: "2025-10-29 15:20", event: "Dashcam still and clip metadata filed by Fleet Safety" },
        ],
      },
      parties: {
        type: "parties",
