...
export const DEMO_EVIDENCE: EvidenceItem[] = [
  ...
  },
  {
    ...
    description:
      "Wide-angle shot of the Westfield Plaza Lot C where the incident occurred. Adjacent stall markings and nearby signage visible.",
    mimeType: "image/jpeg",
  },
  {
    id: "ev-005",
    ...
    description:
      "Initial note from adjuster: damage consistent with low-speed parking lot contact. No frame or structural involvement suspected. Repair estimate expected in the $800–$1,400 range. No police report filed; incident deemed non-reportable per state threshold.",
    mimeType: "text/plain",
  },
  {
    id: "ev-006",
